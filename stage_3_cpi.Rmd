...
In this code we will extract surface current velocity and dirction data from the Copernicus Marine Service. This data will be used to develop an index quntifying current alignment and propagation across hexagons (i.e., CPI).
...
e_n_maps
#ggsave(filename ="./plots/e_n_maps_all.png" ,plot =e_n_maps ,device = "jpeg",units = "cm",width = 20,height = 20)
```
...
dci_p_map
#ggsave(filename ="./plots/dci_p_map_all.png" ,plot =dci_p_map ,device = "jpeg",units = "cm",width = 20,height = 12)
```

#2) Current Propagation Index (CPI)
This index gives more weight for the propgation effect. Hexagons aligned with nearby hexagons are taken into account.
...
print(direction_map)
# ggsave(filename ="./plots/direction_map_all.png" ,plot =direction_map ,device = "jpeg",units = "cm",width = 20,height = 12)
...
#ggsave(filename =".plots/component_B_propagation_map_all.png" ,plot =component_B_propagation_map ,device = "jpeg",units = "cm",width = 20,height = 12)
```
...
#ggsave(filename ="./plots/component_B_propagation_map_dd_all.png" ,plot =cpi_map ,device = "jpeg",units = "cm",width = 20,height = 12)
