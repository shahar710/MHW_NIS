...
write.csv(R2_partition_results_df,"./glmms/model_1_global/R2_partition_results_df_test_main.csv",row.names = F)
...
write_rds(test_main_gg_cint,
  "./glmms/model_1_global/test_main_gg_cint.rds")
write_rds(test_main_gg_yr,
  "./glmms/model_1_global/test_main_gg_yr.rds")
write_rds(test_main_gg_sst,
 "./glmms/model_1_global/test_main_gg_sst.rds")
write_rds(test_main_gg_source,
"./glmms/model_1_global/test_main_gg_source.rds")
write_rds(test_main_gg_cpi,
"./glmms/model_1_global/test_main_gg_cpi.rds")
write_rds(test_main_gg_yfr,
"./glmms/model_1_global/test_main_gg_yfr.rds")
write_rds(test_main_gg_s_sst,
"./glmms/model_1_global/test_main_gg_s_sst.rds")
```
