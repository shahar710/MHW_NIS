...
max_c_int_map <- ggplot() +
  ...
  # Apply a clean theme and labels
  labs(
    title = "C) Spatial cumulative intensity",
    x = "Longitude",
    y = "Latitude"
  ) +
  theme_bw() +
...
spatial_temp_panel=gridExtra::grid.arrange(bottom="Longitude",
  ...
  layout_matrix = rbind(c(1),
                        c(2),
                        c(3)))
ggsave(filename ="spatial_temp_panel.png" ,plot =spatial_temp_panel ,device = "jpeg",units = "cm",width = 13,height = 26)
```
